		...
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<p>
					...
					<br>
					<br> Three teams were formed out of 15 students to each build the same site. Upon soft launch, each site was evaluated and one was chosen to be deployed by the students of HST 251. My team's site was the one selected and can be viewed below at the
					live domain.
				</p>
